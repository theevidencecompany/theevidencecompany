...
function App() {
  ...
  const calculators = [
    {
      ...
      href: "Calculate Mean.html",
      active: false
    },
    {
      title: "Calculate Weighted Mean",
      href: "Calculate Weighted Mean.html",
      active: false
    },
    {
      title: "Calculate Median",
      href: "Calculate Median.html",
      active: false
    },
    {
      title: "Calculate Mode",
      href: "Calculate Mode.html",
      active: false
    },
    {
      title: "Calculate Trimmed/Winsorized mean",
      href: "Calculate Trimmed/Winsorized mean.html",
      active: false
    },
    {
      title: "Calculate Variance",
      href: "Calculate Variance.html",
      active: false
    },
    {
      title: "Calculate Standard Deviation",
      href: "Calculate Standard Deviation.html",
      active: false
    },
    {
      title: "Calculate Standard Error",
      href: "Calculate Standard Error.html",
      active: false
    },
    {
      title: "Calculate Mean Absolute Deviation",
      href: "Calculate Mean Absolute Deviation.html",
      active: false
    },
    {
      title: "Calculate IQR",
      href: "Calculate IQR.html",
      active: false
    },
    {
      title: "Calculate Percentiles",
      href: "Calculate Percentiles.html",
      active: false
    },
    {
      title: "Calculate Five-Number Summary",
      href: "Calculate Five-Number Summary.html",
      active: false
    },
    {
      title: "Calculate z-scores",
      href: "Calculate z-scores.html",
      active: false
    },
    {
      title: "Check Skewness",
      href: "Check Skewness.html",
      active: false
    },
    {
      title: "Kurtosis",
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen flex flex-col" }, /* @__PURE__ */ React.createElement("header", { className: "header-bg py-4 sticky top-0 z-50" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-7xl mx-auto px-6 flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 transition-opacity hover:opacity-80 cursor-pointer" }, /* @__PURE__ */ React.createElement("img", { src: "Entropy.png", alt: "Entro.py", className: "h-8 drop-shadow-sm" })), /* @__PURE__ */ React.createElement("a", { href: "Title page.html", className: "btn-back" }, React.createElement(ArrowLeftIcon, { className: "w-4 h-4" }), "Back to Tools"))), /* @__PURE__ */ React.createElement("main", { className: "flex-grow max-w-7xl mx-auto px-6 py-12 w-full z-0 relative" }, /* @__PURE__ */ React.createElement("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-gradient-to-tr from-[#184B44]/5 to-transparent rounded-full blur-3xl -z-10 pointer-events-none" }), /* @__PURE__ */  /* @__PURE__ */ React.createElement("div", { className: "text-center mb-12 animate-fade-up", style: { animationDelay: "0.1s" } }, /* @__PURE__ */ React.createElement("h1", { className: "text-4xl font-bold text-[#184B44] mb-4 tracking-tight" }, "Descriptive Statistics"), /* @__PURE__ */ React.createElement("p", { className: "text-slate-500 text-lg max-w-2xl mx-auto" }, "Explore, summarize, and understand your data distributions with these core statistical tools.")), /* @__PURE__ */ React.createElement("div", { className: "search-container animate-fade-up", style: { animationDelay: "0.2s" } }, /* @__PURE__ */ React.createElement(
    ...
    "a",
    {
      key: index,
      href: "#",
      className: `stat-card group ${!calc.active ? "opacity-70 grayscale hover:grayscale-0 hover:opacity-100" : ""}`
    },
  ...
  )), filteredCalculators.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "col-span-full text-center py-16 text-slate-400 bg-white rounded-xl border border-dashed border-slate-300" }, /* @__PURE__ */ React.createElement("div", { className: "mb-2 text-4xl" }, "\u{1F50D}"), /* @__PURE__ */ React.createElement("p", { className: "text-lg font-medium text-slate-600" }, "No calculators found"), /* @__PURE__ */ React.createElement("p", null, "Try adjusting your search terms")))), /* @__PURE__ */ React.createElement("footer", { className: "site-footer" }, React.createElement("div", { className: "site-footer-inner" }, "Entropy | © 2025 Threadminds. All rights reserved.")));
}
