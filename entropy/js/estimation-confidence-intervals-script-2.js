...
function App() {
  ...
  const estimators = [
    {
      title: "Confidence Interval for 1-sample mean",
      href: "",
      active: false
    },
    {
      title: "Confidence Interval for 2-sample mean",
      href: "",
      active: false
    },
    {
    ...
    {
      title: "Confidence Interval for SD",
      href: "",
      active: false
    },
    {
      title: "Correlation Confidence Interval",
      href: "",
      active: false
    },
    {
  ...
  )), filteredEstimators.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "col-span-full text-center py-16 text-slate-400 bg-white rounded-xl border border-dashed border-slate-300" }, /* @__PURE__ */ React.createElement("div", { className: "mb-2 text-4xl" }, "\u{1F50D}"), /* @__PURE__ */ React.createElement("p", { className: "text-lg font-medium text-slate-600" }, "No estimators found"), /* @__PURE__ */ React.createElement("p", null, "Try adjusting your search terms")))), /* @__PURE__ */ React.createElement("footer", { className: "site-footer" }, React.createElement("div", { className: "site-footer-inner" }, "Entropy | © 2025 Threadminds. All rights reserved.")));
}
