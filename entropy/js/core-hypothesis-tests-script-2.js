...
function App() {
  ...
  const tests = [
    {
      ...
      href: "1 sample z test.html",
      active: false
    },
    {
      title: "2 sample z test",
      href: "2 sample z test.html",
      active: false
    },
    {
      title: "paired sample z test",
      href: "paired sample z test.html",
      active: false
    },
    {
      title: "1 sample t tests",
      href: "1 sample t tests.html",
      active: false
    },
    {
      title: "2 sample t tests",
      href: "2 sample t tests.html",
      active: false
    },
    {
      title: "paried sample t tests",
      href: "paried sample t tests.html",
      active: false
    },
    {
      title: "\u03C7\xB2 tests for variance",
      href: "\u03C7\xB2 tests for variance.html",
      active: false
    },
    {
      title: "F tests for variance",
      href: "F tests for variance.html",
      active: false
    },
    {
      title: "\u03C7\xB2 tests for goodness-of-fit",
      href: "\u03C7\xB2 tests for goodness-of-fit.html",
      active: false
    },
    {
      title: "\u03C7\xB2 tests for independence",
      href: "\u03C7\xB2 tests for independence.html",
      active: false
    }
  ];
  const filteredTests = tests.filter(
    (test) => test.title.toLowerCase().includes(searchQuery.toLowerCase())
  );
  return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen flex flex-col" }, /* @__PURE__ */ React.createElement("header", { className: "header-bg py-4 sticky top-0 z-50" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-7xl mx-auto px-6 flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 transition-opacity hover:opacity-80 cursor-pointer" }, /* @__PURE__ */ React.createElement("img", { src: "Entropy.png", alt: "Entro.py", className: "h-8 drop-shadow-sm" })), /* @__PURE__ */ React.createElement("a", { href: "Title page.html", className: "btn-back" }, React.createElement(ArrowLeftIcon, { className: "w-4 h-4" }), "Back to Tools"))), /* @__PURE__ */ React.createElement("main", { className: "flex-grow max-w-7xl mx-auto px-6 py-12 w-full z-0 relative" }, /* @__PURE__ */ React.createElement("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-gradient-to-tr from-[#184B44]/5 to-transparent rounded-full blur-3xl -z-10 pointer-events-none" }), /* @__PURE__ */  /* @__PURE__ */ React.createElement("div", { className: "text-center mb-12 animate-fade-up", style: { animationDelay: "0.1s" } }, /* @__PURE__ */ React.createElement("h1", { className: "text-4xl font-bold text-[#184B44] mb-4 tracking-tight" }, "Core Hypothesis Tests"), /* @__PURE__ */ React.createElement("p", { className: "text-slate-500 text-lg max-w-2xl mx-auto" }, "Perform standard statistical hypothesis tests for means, variances, and distributions.")), /* @__PURE__ */ React.createElement("div", { className: "search-container animate-fade-up", style: { animationDelay: "0.2s" } }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      className: "search-input",
      placeholder: "Search for a test (e.g. 'z test', 'variance')...",
      value: searchQuery,
      onChange: (e) => setSearchQuery(e.target.value)
    }
  ), /* @__PURE__ */ React.createElement(SearchIcon, { className: "search-icon" })), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-fade-up", style: { animationDelay: "0.3s" } }, filteredTests.map((test, index) => /* @__PURE__ */ React.createElement(
    "a",
    {
      key: index,
      href: "#",
      className: `test-card group ${!test.active ? "opacity-70 grayscale hover:grayscale-0 hover:opacity-100" : ""}`
    },
    /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-start gap-1" }, /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-700 group-hover:text-[#184B44] transition-colors pr-4" }, test.title), /* @__PURE__ */ React.createElement("span", { className: `text-[10px] uppercase tracking-wider font-bold px-2 py-0.5 rounded-full ${test.active ? "text-teal-700 bg-teal-50 border border-teal-100" : "text-slate-400 bg-slate-100 border border-slate-200"}` }, test.active ? "Active" : "Soon")),
  ...
  )), filteredTests.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "col-span-full text-center py-16 text-slate-400 bg-white rounded-xl border border-dashed border-slate-300" }, /* @__PURE__ */ React.createElement("div", { className: "mb-2 text-4xl" }, "\u{1F50D}"), /* @__PURE__ */ React.createElement("p", { className: "text-lg font-medium text-slate-600" }, "No tests found"), /* @__PURE__ */ React.createElement("p", null, "Try adjusting your search terms")))), /* @__PURE__ */ React.createElement("footer", { className: "site-footer" }, React.createElement("div", { className: "site-footer-inner" }, "Entropy | © 2025 Threadminds. All rights reserved.")));
}
